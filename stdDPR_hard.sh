...
train_data_name=dr_drd
nn_txt=train.query.top1k.run.txt
...
python build_train_nn.py \
  ...
  --nn_file msmarco_passage/newresults/dr_oq/bert_base_q32p128_pdbs16_lr5e-6_ep4/Flat/${nn_txt} \
...
python test.py data/msmarco_passage/raw/qrels.dev.tsv msmarco_passage/newresults/${model_name}/bert_base_q32p128_pdbs16_lr5e-6_ep4/Flat/queries.dev.small.top1k.run.txt
