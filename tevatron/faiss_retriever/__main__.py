...
def main():
    ...
    # torch.save((all_scores, psg_indices), 'retrieval_results.pt')
    torch.save((all_scores, psg_indices), 'retrieval_results.pt', pickle_protocol=4)

    logger.info('Retrieval results saved to retrieval_results.pt')
